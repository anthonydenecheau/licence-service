...
public class ResponseObjectList<T> {
	...
	@ApiModelProperty(notes = "The Total of licences", position = 1, required = true)
	private int itemsCount;
	
	@ApiModelProperty(notes = "The list of licences", position = 2, required = true, allowEmptyValue=true)
